...
export function AdminUserManagement() {
  ...
  const handleAddStudent = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        // 2. Automatically Create Login Account
        await fetch(`${API_BASE_URL}/users`, {
          ...
          body: JSON.stringify({
            name: newStudent.name,
            email: newStudent.email,
            password: newStudent.password || "student123", // Use inputted password or fallback
            role: "student",
          }),
        });
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                  ...
                  <div className="space-y-2">
                    <Select
                      ...
                      onValueChange={(val) =>
                        setNewStudent({ ...newStudent, enrolledClass: val })
                      }
                    >
                      <SelectTrigger>
                  ...
                  {/* 5. PASSWORD (Only show when adding a new student) */}
                  {!editingId && (
                    <div className="space-y-2">
                      <Input
                        type="password"
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      setNewStudent({
                        ...
                        enrolledClass: "Grade 10-A",
                        status: "active",
                        password: "", // Make sure to clear this too!
                      });
                    }}
                  >
                    Cancel
                    ...
                    <TableRow key={record.id} className="hover:bg-gray-50">
                      ...
                      <TableCell className="text-center">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent
                            align="end"
                            className="bg-white z-50 shadow-lg border border-gray-200 min-w-[150px]"
                          >
